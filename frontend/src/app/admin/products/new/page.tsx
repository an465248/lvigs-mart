...
export default function NewProductPage() {
  ...
  const [form, setForm] = useState({
    title: "", brand: "", categoryId: "mobiles", sellerId: "s1", sellerName: "LVIGS Store",
    description: "", highlights: "", mrp: "", price: "", stock: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    adminMock.addProduct({
      title: form.title, brand: form.brand, brandId: "b1", categoryId: form.categoryId,
        ...
        <CardBody>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Input label="Brand" required value={form.brand} onChange={e => set("brand", e.target.value)} placeholder="e.g. Apple" />
            ...
            <Textarea label="Description" value={form.description} onChange={e => set("description", e.target.value)} placeholder="Product description..." />
            ...
            <Input label="Warranty" value={form.warranty} onChange={e => set("warranty", e.target.value)} placeholder="e.g. 1 Year Manufacturer" />
